...
HD_PWD='C:/Users/Administrator/Hoang_Design/Example/2.softcore/FFT_IP_Core-master/FFT_IP_Core-master/core_2/core_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Control_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FFT_Control_3.tcl -notrace

...
HD_PWD='C:/Users/Administrator/Hoang_Design/Example/2.softcore/FFT_IP_Core-master/FFT_IP_Core-master/core_2/core_2.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Control_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_Control_3.tcl
